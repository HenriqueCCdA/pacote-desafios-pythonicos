...
def match_ends_v1(words):
    # +++ SUA SOLUÇÃO +++

    contador = 0
    for word in words:
        # tirando vantagem do curto circuito
...
def match_ends_v2(words):
    # +++ SUA SOLUÇÃO +++

    return len([ ' ' for word in words if len(word) > 1 and word[0] == word[-1]])


match_ends = match_ends_v2
